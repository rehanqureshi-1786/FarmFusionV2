...
async def test_07_multilingual_weather_advice_and_alerts():
    ...
    assert any(en_curr["weather"].lower().startswith(x) for x in ["clear", "mainly", "partly", "overcast", "rain", "fog", "weather", "drizzle", "light", "heavy", "moderate", "thunderstorm", "snow", "showers"])
