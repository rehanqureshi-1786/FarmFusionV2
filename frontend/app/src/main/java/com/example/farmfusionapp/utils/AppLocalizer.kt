...
object AppLocalizer {
    ...
    private val DISEASES = mapOf(
        ...
        "yellow rust" to mapOf(
            "en" to "Yellow Rust / Stripe Rust", "hi" to "पीला रतुआ रोग (स्ट्राइप रस्ट)",
            "mr" to "पिवळा तांबेरा रोग", "gu" to "પીળો ગેરુ રોગ",
            "pa" to "ਪੀਲੀ ਕੁੰਗੀ ਰੋਗ", "bn" to "হলুদ মরিচা রোগ",
            "ta" to "மஞ்சள் துரு நோய்", "te" to "పసుపు తుప్పు తెగులు",
            "kn" to "ಹಳದಿ ತುಕ್ಕು ರೋಗ", "ml" to "മഞ്ഞ തുരുമ്പ് രോഗം",
            "or" to "ହଳଦିଆ କଳଙ୍କି ରୋଗ", "as" to "হালধীয়া মামৰ ৰোগ",
            "ur" to "زرد زنگ", "mai" to "पीयर गेरुआ रोग",
            "od" to "ହଳଦିଆ କଳଙ୍କି ରୋଗ"
        ),
        "bacterial blight" to mapOf(
            "en" to "Bacterial Blight", "hi" to "जीवाणु झुलसा रोग (बैक्टीरियल ब्लाइट)",
            "mr" to "जिवाणूजन्य करपा", "gu" to "જીવાણુ સુકારો",
            "pa" to "ਜੀਵਾਣੂ ਝੁਲਸ ਰੋਗ", "bn" to "ব্যাকটেরিয়াল ব্লাইট রোগ",
            "ta" to "பாக்டீரியா கருகல் நோய்", "te" to "బ్యాక్టీరియా బ్లైట్ తెగులు",
            "kn" to "ಬ್ಯಾಕ್ಟೀರಿಯಾ ಕರಕಲು ರೋಗ", "ml" to "ബാക്ടീരിയൽ കരിച്ചിൽ",
            "or" to "ଜୀବାଣୁ ଝାଉଁଳା ରୋଗ", "as" to "বেক্টেৰিয়াজনিত শুকোৱা ৰোগ",
            "ur" to "بیکٹیریل جھلسائو", "mai" to "जीवाणु झुलसा",
            "od" to "ଜୀବାଣୁ ଝାଉଁଳା ରୋଗ"
        ),
        "curl virus" to mapOf(
            "en" to "Leaf Curl Virus", "hi" to "पत्ती मरोड़ विषाणु रोग (कर्ल वायरस)",
            "mr" to "पाने आकसणे विषाणू रोग (पर्णगुच्छ)", "gu" to "પાન વળવાનો રોગ (કુકડવો)",
            "pa" to "ਪੱਤਾ ਮਰੋੜ ਵਿਸ਼ਾਣੂ ਰੋਗ", "bn" to "পাতা কোকড়ানো ভাইরাস রোগ",
            "ta" to "இலை சுருட்டு வைரஸ் நோய்", "te" to "ఆకు ముడుత వైరస్ తెగులు",
            "kn" to "ಎಲೆ ಮುದುರು ವೈರಸ್ ರೋಗ", "ml" to "ഇല ചുരുളൽ വൈറസ്",
            "or" to "ପତ୍ର ମୋଡ଼ା ଭୂତାଣୁ ରୋଗ", "as" to "পাত কুঁচিওৱা ভাইৰাছ ৰোগ",
            "ur" to "پتوں کا مڑنا وائرس", "mai" to "पत्ता मरोड़ विषाणु",
            "od" to "ପତ୍ର ମୋଡ଼ା ଭୂତାଣୁ ରୋଗ"
        ),
        "rice blast" to mapOf(
            "en" to "Rice Blast", "hi" to "धान का झोंका रोग (ब्लास्ट)",
            "mr" to "भातावरील करपा (ब्लास्ट)", "gu" to "ડાંગરનો ગેરુ / બ્લાસ્ટ",
            "pa" to "ਝੋਨੇ ਦਾ ਬਲਾਸਟ ਰੋਗ", "bn" to "ধানের ব্লাস্ট রোগ",
            "ta" to "நெல் குலை நோய்", "te" to "వరి అగ్గి తెగులు (బ్లాస్ట్)",
            "kn" to "ಭತ್ತದ ಬೆಂಕಿ ರೋಗ (ಬ್ಲಾಸ್ಟ್)", "ml" to "നെല്ലിന്റെ ബ്ലാസ്റ്റ് രോഗം",
            "or" to "ଧାନ ଚିଆଁ ରୋଗ (ବ୍ଲାଷ୍ଟ)", "as" to "ধানৰ ব্লাষ্ট ৰোগ",
            "ur" to "چاول کا بلاسٹ", "mai" to "धानक झोंका (ब्लास्ट)",
            "od" to "ଧାନ ଚିଆଁ ରୋଗ (ବ୍ଲାଷ୍ଟ)"
        ),
        "brown spot" to mapOf(
            "en" to "Brown Spot", "hi" to "भूरा धब्बा रोग (ब्राउन स्पॉट)",
            "mr" to "तपकिरी ठिपके रोग", "gu" to "બદામી ટપકાં રોગ",
            "pa" to "ਭੂਰਾ ਧੱਬਾ ਰੋਗ", "bn" to "বাদামি দাগ রোগ",
            "ta" to "பழுப்பு புள்ளி நோய்", "te" to "గోధుమ రంగు మచ్చ తెగులు",
            "kn" to "ಕಂದು ಕಲೆ ರೋಗ", "ml" to "തവിട്ടുപൊട്ടു രോഗം",
            "or" to "ବାଦାମୀ ଦାଗ ରୋଗ", "as" to "বাদামী দাগ ৰোগ",
            "ur" to "بھورا داغ", "mai" to "भूरा धब्बा रोग",
            "od" to "ବାଦାମୀ ଦାଗ ରୋଗ"
        ),
        "sheath blight" to mapOf(
            "en" to "Sheath Blight", "hi" to "शीथ झुलसा रोग",
            "mr" to "पर्णकोश करपा", "gu" to "પર્ણકવચ સુકારો",
            "pa" to "ਸ਼ੀਥ ਬਲਾਈਟ", "bn" to "খোল পোড়া রোগ",
            "ta" to "உறை கருகல் நோய்", "te" to "పొర తెగులు (షీత్ బ్లైట్)",
            "kn" to "ಹಾಳೆ ಕರಕಲು ರೋಗ", "ml" to "പോളക്കരിച്ചിൽ",
            "or" to "ପତ୍ର ଆଚ୍ଛାଦନ ଝାଉଁଳା ରୋଗ", "as" to "খোল শুকোৱা ৰোগ",
            "ur" to "شیٹھ بلائٹ", "mai" to "शीथ झुलसा",
            "od" to "ପତ୍ର ଆଚ୍ଛାଦନ ଝାଉଁଳା ରୋଗ"
        ),
        "karnal bunt" to mapOf(
            "en" to "Karnal Bunt", "hi" to "करनाल बंट रोग",
            "mr" to "कर्नाल बंट रोग", "gu" to "કરનાલ બંટ રોગ",
            "pa" to "ਕਰਨਾਲ ਬੰਟ ਰੋਗ", "bn" to "কারনাল বান্ট রোগ",
            "ta" to "கர்னால் பன்ட் நோய்", "te" to "కర్నాల్ బంట్ తెగులు",
            "kn" to "ಕರ್ನಾಲ್ ಬಂಟ್ ರೋಗ", "ml" to "കർണാൽ ബണ്ട് രോഗം",
            "or" to "କର୍ନାଲ୍ ବଣ୍ଟ୍ ରୋଗ", "as" to "কৰ্ণাল বান্ট ৰোগ",
            "ur" to "کرنال بنٹ", "mai" to "करनाल बंट",
            "od" to "କର୍ନାଲ୍ ବଣ୍ଟ୍ ରୋଗ"
        ),
        "loose smut" to mapOf(
            "en" to "Loose Smut", "hi" to "कंडुआ रोग (लूज स्मट)",
            "mr" to "काजळी रोग (लूज स्मट)", "gu" to "કાળી અંગારીયો (લૂઝ સ્મટ)",
            "pa" to "ਕਾਂਗਿਆਰੀ ਰੋਗ", "bn" to "লুজ স্মাট রোগ",
            "ta" to "கரிப்பூட்டை நோய்", "te" to "కాటుక తెగులు (లూజ్ స్మట్)",
            "kn" to "ಕಾಡಿಗೆ ರೋಗ", "ml" to "കരിമ്പൂപ്പ് രോഗം",
            "or" to "କଳା ପୋଡ଼ିଆ ରୋଗ", "as" to "লুজ স্মাট ৰোগ",
            "ur" to "لوز سمٹ", "mai" to "कंडुआ रोग",
            "od" to "କଳା ପୋଡ଼ିଆ ରୋଗ"
        ),
        "no plant detected" to mapOf(
            "en" to "No Plant Detected",
            "hi" to "कोई पौधा नहीं मिला",
            "gu" to "કોઈ છોડ મળ્યો નથી",
            "mr" to "कोणतीही वनस्पती आढळली नाही",
            "pa" to "ਕੋਈ ਪੌਦਾ ਨਹੀਂ ਮਿਲਿਆ",
            "bn" to "কোনো গাছ শনাক্ত করা যায়নি",
            "ta" to "எந்த செடியும் கண்டறியப்படவில்லை",
            "te" to "ఎటువంటి మొక్క కనుగొనబడలేదు",
            "kn" to "ಯಾವುದೇ ಸಸ್ಯ ಪತ್ತೆಯಾಗಿಲ್ಲ",
            "ml" to "ചെടിയൊന്നും കണ്ടെത്തിയില്ല",
            "or" to "କୌଣସି ଗଛ ଚିହ୍ନଟ ହୋଇନାହିଁ",
            "as" to "কোনো উদ্ভিদ চিনাক্ত হোৱা নাই",
            "ur" to "کوئی پودا نہیں ملا",
            "mai" to "कोनो पौधा नहि भेटल"
        ),
    ...
    private val ADVICE_PATTERNS = listOf(
        ...
        Pair("stake tomato", mapOf(
            "en" to "Stake tomato plants and mulch soil surface to prevent soil splash onto lower foliage", "hi" to "निचली पत्तियों पर मिट्टी के छींटों को रोकने के लिए पौधों को सहारा (स्टेकिंग) दें और मल्चिंग करें",
            "mr" to "खालच्या पानांवर माती उडणे रोखण्यासाठी रोपांना आधार द्या आणि आच्छादन (मल्चिंग) करा", "gu" to "નીચેના પાન પર માટી ઉડતી અટકાવવા છોડને ટેકો આપો અને મલ્ચિંગ કરો",
            "pa" to "ਹੇਠਲੇ ਪੱਤਿਆਂ 'ਤੇ ਮਿੱਟੀ ਪੈਣ ਤੋਂ ਰੋਕਣ ਲਈ ਬੂਟਿਆਂ ਨੂੰ ਸਹਾਰਾ ਦਿਓ ਅਤੇ ਮਲਚਿੰਗ ਕਰੋ", "bn" to "নীচের পাতায় মাটির ছিটা লাগা রোধ করতে গাছে খুঁটি দিন এবং মালচিং করুন",
            "ta" to "கீழ் இலைகளில் மண் தெறிப்பதைத் தடுக்க செடிகளுக்கு முட்டுக் கொடுத்து மூடாக்கு இடவும்", "te" to "కింది ఆకులపై మట్టి పడకుండా నిరోధించడానికి మొక్కలకు కర్రల ఆసరా ఇచ్చి మల్చింగ్ చేయండి",
            "kn" to "ಕೆಳಗಿನ ಎಲೆಗಳಿಗೆ ಮಣ್ಣು ಸಿಡಿಯುವುದನ್ನು ತಪ್ಪಿಸಲು ಸಸಿಗಳಿಗೆ ಆಸರೆ ಕೊಟ್ಟು ಮಲ್ಚಿಂಗ್ ಮಾಡಿ", "ml" to "താഴത്തെ ഇലകളിൽ മണ്ണടിയുന്നത് തടയാൻ താങ്ങ് നൽകുകയും പുതയിടുകയും ചെയ്യുക",
            "or" to "ତଳ ପତ୍ରରେ ମାଟି ଛିଟିକିବା ରୋକିବା ପାଇଁ ଗଛକୁ ଆଶ୍ରୟ ଦିଅନ୍ତୁ ଏବଂ ମଲଚିଂ କରନ୍ତୁ", "as" to "তলৰ পাতত মাটি ছটিওৱা বন্ধ কৰিবলৈ গছত জেং দিয়ক আৰু মালচিং কৰক",
            "ur" to "نچلے پتوں پر مٹی کے چھینٹوں کو روکنے کے لیے پودوں کو سہارا دیں اور ملچنگ کریں", "mai" to "नीचा केर पत्ता पर माटि पड़य सं रोकबाक लेल गाछ केँ सहारा दियौ आ मल्चिंग करू",
            "od" to "ତଳ ପତ୍ରରେ ମାଟି ଛିଟିକିବା ରୋକିବା ପାଇଁ ଗଛକୁ ଆଶ୍ରୟ ଦିଅନ୍ତୁ ଏବଂ ମଲଚିଂ କରନ୍ତୁ"
        )),

        Pair("prune bottom leaves", mapOf(
            "en" to "Prune bottom leaves (15-20 cm above ground) to improve air circulation", "hi" to "हवा का संचार सुधारने के लिए जमीन से 15-20 सेमी ऊपर की निचली पत्तियों की छंटाई करें",
            "mr" to "हवा खेळती राहण्यासाठी जमिनीपासून १५-२० सेमी वरील खालची पाने छाटून टाका", "gu" to "હવાની અવરજવર સુધારવા માટે જમીનથી 15-20 સેમી ઊંચાઈ સુધીના નીચેના પાંદડાં દૂર કરો",
            "pa" to "ਹਵਾ ਦੇ ਆਉਣ-ਜਾਣ ਵਿੱਚ ਸੁਧਾਰ ਲਈ ਜ਼ਮੀਨ ਤੋਂ 15-20 ਸੈਂਟੀਮੀਟਰ ਉੱਪਰਲੇ ਹੇਠਲੇ ਪੱਤਿਆਂ ਦੀ ਛਾਂਟੀ ਕਰੋ", "bn" to "বাতাস চলাচল বাড়াতে মাটি থেকে ১৫-২০ সেমি উপরের নিচের পাতা ছাঁটাই করুন",
            "ta" to "காற்று சுழற்சியை மேம்படுத்த தரையிலிருந்து 15-20 செ.மீ உயரமுள்ள கீழ் இலைகளை கவாத்து செய்யவும்", "te" to "గాలి ప్రసరణను మెరుగుపరచడానికి నేల నుండి 15-20 సెం.மீ ఎత్తులోని కింది ఆకులను కత్తిరించండి",
            "kn" to "ಗಾಳಿಯಾಡುವಿಕೆಯನ್ನು ಸುಧಾರಿಸಲು ನೆಲದಿಂದ 15-20 ಸೆಂ.ಮೀ ಎತ್ತರದ ಕೆಳಗಿನ ಎಲೆಗಳನ್ನು ತೆಗೆಯಿರಿ", "ml" to "വായുസഞ്ചാരം മെച്ചപ്പെടുത്താൻ നിലത്തുനിന്ന് 15-20 സെ.മീ ഉയരത്തിലുള്ള താഴത്തെ ഇലകൾ വെട്ടിമാറ്റുക",
            "or" to "ବାୟୁ ଚଳାଚଳ ବୃଦ୍ଧି ପାଇଁ ମାଟିଠାରୁ ୧୫-୨୦ ସେମି ଉପରେ ଥିବା ତଳ ପତ୍ରଗୁଡ଼ିକୁ କାଟି ଦିଅନ୍ତୁ", "as" to "বতাহ চলাচল উন্নত কৰিবলৈ মাটিৰ পৰা ১৫-২০ চে.মি. ওপৰৰ তলৰ পাতবোৰ কাটি পেলাওক",
            "ur" to "ہوا کی نکاسی کو بہتر بنانے کے لیے زمین سے 15-20 سینٹی میٹر اوپر کے نچلے پتوں کی کٹائی کریں", "mai" to "हवाक संचार सुधरबाक लेल जमीन सं 15-20 सेमी ऊपरक नीचा केर पत्ता केँ काटि हटाउ",
            "od" to "ବାୟୁ ଚଳାଚଳ ବୃଦ୍ଧି ପାଇଁ ମାଟିଠାରୁ ୧୫-୨୦ ସେମି ଉପରେ ଥିବା ତଳ ପତ୍ରଗୁଡ଼ିକୁ କାଟି ଦିଅନ୍ତୁ"
        )),

        Pair("trichoderma viride", mapOf(
            "en" to "Biological: Foliar application of Trichoderma viride @ 5 g/L or Pseudomonas fluorescens @ 5 g/L", "hi" to "जैविक नियंत्रण: ट्राइकोडर्मा विरिडी (5 ग्राम/लीटर) या स्यूडोमोनास फ्लोरोसेंस (5 ग्राम/लीटर) का पत्तियों पर छिड़काव करें",
            "mr" to "जैविक उपाय: ट्रायकोडर्मा व्हिरिडी (५ ग्रॅम/लिटर) किंवा स्यूडोमोनास फ्लोरोसन्स (५ ग्रॅम/लिटर) ची पानांवर फवारणी करा", "gu" to "જૈવિક નિયંત્રણ: ટ્રાઇકોડર્મા વિરીડી (5 ગ્રામ/લિટર) અથવા સ્યુડોમોનાસ ફ્લોરોસેન્સ (5 ગ્રામ/લિટર) નો પાન પર છંટકાવ કરો",
            "pa" to "ਜੈਵਿਕ ਰੋਕਥਾਮ: ਟ੍ਰਾਈਕੋਡਰਮਾ ਵਿਰੀਡੀ (5 ਗ੍ਰਾਮ/ਲੀਟਰ) ਜਾਂ ਸੂਡੋਮੋਨਾਸ ਫਲੋਰੋਸੈਂਸ (5 ਗ੍ਰਾਮ/ਲੀਟਰ) ਦਾ ਛਿੜਕਾਅ ਕਰੋ", "bn" to "জৈব নিয়ন্ত্রণ: ট্রাইকোডার্মা ভিরিডি (৫ গ্রাম/লিটার) বা সিউডোমোনাস ফ্লুরোসেন্স (৫ গ্রাম/লিটার) পাতায় স্প্রে করুন",
            "ta" to "இயற்கை கட்டுப்பாடு: டிரைக்கோடெர்மா விரிடி (5 கிராம்/லிட்டர்) அல்லது சூடோமோனாஸ் (5 கிராம்/லிட்டர்) இலைகளில் தெளிக்கவும்", "te" to "జీవ నియంత్రణ: ట్రైకోడెర్మా విరిడి (5 గ్రా/లీ) లేదా సూడోమోనాస్ ఫ్లోరోసెన్స్ (5 గ్రా/లీ) ఆకులపై పిచికారీ చేయండి",
            "kn" to "ಜೈವಿಕ ನಿಯಂತ್ರಣ: ಟ್ರೈಕೋಡರ್ಮಾ ವಿರಿಡಿ (5 ಗ್ರಾಂ/ಲೀಟರ್) ಅಥವಾ ಸ್ಯೂಡೋಮೊನಾಸ್ (5 ಗ್ರಾಂ/ಲೀಟರ್) ಸಿಂಪಡಿಸಿ", "ml" to "ജൈവ നിയന്ത്രണം: ട്രൈക്കോഡെർമ വിരിഡി (5 ഗ്രാം/ലിറ്റർ) അല്ലെങ്കിൽ സ്യൂഡോമോണസ് (5 ഗ്രാം/ലിറ്റർ) ഇലകളിൽ തളിക്കുക",
            "or" to "ଜୈବିକ ନିୟନ୍ତ୍ରଣ: ଟ୍ରାଇକୋଡର୍ମା ଭିରିଡି (୫ ଗ୍ରାମ୍/ଲିଟର) କିମ୍ବା ସୁଡୋମୋନାସ୍ (୫ ଗ୍ରାମ୍/ଲିଟର) ପତ୍ରରେ ସ୍ପ୍ରେ କରନ୍ତୁ", "as" to "জৈৱিক নিয়ন্ত্ৰণ: ট্ৰাইক'ডাৰ্মা ভিৰিডি (৫ গ্ৰাম/লিটাৰ) বা চিউড'ম'নাচ (৫ গ্ৰাম/লিটাৰ) পাতত ছটিওৱক",
            "ur" to "حیاتیاتی کنٹرول: ٹرائیکوڈرما وریڈی (5 گرام فی لیٹر) یا سیوڈوموناس فلوروسینس (5 گرام/لیٹر) کا سپرے کریں", "mai" to "जैविक नियंत्रण: ट्राइकोडर्मा विरिडी (5 ग्राम/लीटर) वा स्यूडोमोनास फ्लोरोसेंस केर पत्ता पर छिड़काव करू",
            "od" to "ଜୈବିକ ନିୟନ୍ତ୍ରଣ: ଟ୍ରାଇକୋଡର୍ମା ଭିରିଡି (୫ ଗ୍ରାମ୍/ଲିଟର) କିମ୍ବା ସୁଡୋମୋନାସ୍ (୫ ଗ୍ରାମ୍/ଲିଟର) ପତ୍ରରେ ସ୍ପ୍ରେ କରନ୍ତୁ"
        )),

        Pair("mancozeb 75% wp", mapOf(
            "en" to "Chemical: Foliar spray of Mancozeb 75% WP @ 2.5 g/L or Chlorothalonil 75% WP @ 2.0 g/L as preventive spray", "hi" to "रासायनिक उपाय: मैंकोजेब 75% WP (2.5 ग्राम/लीटर) या क्लोरोथैलोनिल 75% WP (2.0 ग्राम/लीटर) का सुरक्षात्मक छिड़काव करें",
            "mr" to "रासायनिक उपाय: मँकोझेब ७५% WP (२.५ ग्रॅम/लिटर) किंवा क्लोरोथॅलोनिल ७५% WP (२.० ग्रॅम/लिटर) ची प्रतिबंधात्मक फवारणी करा", "gu" to "રાસાયણિક ઉપાય: મેન્કોઝેબ 75% WP (2.5 ગ્રામ/લિટર) અથવા ક્લોરોથેલોનિલ 75% WP (2.0 ગ્રામ/લિટર) નો રક્ષણાત્મક છંટકાવ કરો",
            "pa" to "ਰਸਾਇਣਕ ਰੋਕਥਾਮ: ਮੈਨਕੋਜ਼ੇਬ 75% ਡਬਲਯੂ.ਪੀ (2.5 ਗ੍ਰਾਮ/ਲੀਟਰ) ਜਾਂ ਕਲੋਰੋਥੈਲੋਨਿਲ (2.0 ਗ੍ਰਾਮ/ਲੀਟਰ) ਦਾ ਰੋਕਥਾਮ ਛਿੜਕਾਅ ਕਰੋ", "bn" to "রাসায়নিক নিয়ন্ত্রণ: ম্যানকোজেব ৭৫% WP (২.৫ গ্রাম/লিটার) বা ক্লোরোথ্যালোনিল ৭৫% WP (২.০ গ্রাম/লিটার) প্রতিরোধক স্প্রে করুন",
            "ta" to "வேதியியல் கட்டுப்பாடு: மான்கோசெப் 75% WP (2.5 கிராம்/லிட்டர்) அல்லது குளோரோதலோனில் 75% WP (2.0 கிராம்/லிட்டர்) முன்னெச்சரிக்கையாக தெளிக்கவும்", "te" to "రసాయన నియంత్రణ: మాంకోజెబ్ 75% WP (2.5 గ్రా/లీ) లేదా క్లోరోథలోనిల్ 75% WP (2.0 గ్రా/లీ) నివారణ పిచికారీ చేయండి",
            "kn" to "ರಾಸಾಯನಿಕ ನಿಯಂತ್ರಣ: ಮ್ಯಾಂಕೋಜೆಬ್ 75% WP (2.5 ಗ್ರಾಂ/ಲೀಟರ್) ಅಥವಾ ಕ್ಲೋರೋಥಲೋನಿಲ್ 75% WP (2.0 ಗ್ರಾಂ/ಲೀಟರ್) ಸಿಂಪಡಿಸಿ", "ml" to "രാസ നിയന്ത്രണം: മാങ്കോസെബ് 75% WP (2.5 ഗ്രാം/ലിറ്റർ) അല്ലെങ്കിൽ ക്ലോറോതലോനിൽ 75% WP (2.0 ഗ്രാം/ലിറ്റർ) തളിക്കുക",
            "or" to "ରାସାୟନିକ ନିୟନ୍ତ୍ରଣ: ମାଙ୍କୋଜେବ୍ ୭୫% WP (୨.୫ ଗ୍ରାମ୍/ଲିଟର) କିମ୍ବା କ୍ଲୋରୋଥାଲୋନିଲ୍ (୨.୦ ଗ୍ରାମ୍/ଲିଟର) ସ୍ପ୍ରେ କରନ୍ତୁ", "as" to "ৰাসায়নিক নিয়ন্ত্ৰণ: মেনক'জেব ৭৫% WP (২.৫ গ্ৰাম/লিটাৰ) বা ক্ল'ৰ'থেল'নিল (২.০ গ্ৰাম/লিটাৰ) প্ৰতিৰোধক স্প্ৰে কৰক",
            "ur" to "کیمیائی کنٹرول: مینکوزیب 75% ڈبلیو پی (2.5 گرام/لیٹر) یا کلورو تھالونل (2.0 گرام/لیٹر) کا حفاظتی سپرے کریں", "mai" to "रासायनिक नियंत्रण: मैनकोजेब 75% WP (2.5 ग्राम/लीटर) वा क्लोरोथैलोनिल केर सुरक्षात्मक छिड़काव करू",
            "od" to "ରାସାୟନିକ ନିୟନ୍ତ୍ରଣ: ମାଙ୍କୋଜେବ୍ ୭୫% WP (୨.୫ ଗ୍ରାମ୍/ଲିଟର) କିମ୍ବା କ୍ଲୋରୋଥାଲୋନିଲ୍ (୨.୦ ଗ୍ରାମ୍/ଲିଟର) ସ୍ପ୍ରେ କରନ୍ତୁ"
        )),

        Pair("targeted active ingredient", mapOf(
            "en" to "Targeted active ingredient for disease control", "hi" to "रोग नियंत्रण के लिए लक्षित सक्रिय घटक",
            "mr" to "रोग नियंत्रणासाठी प्रभावी घटक", "gu" to "રોગ નિયંત્રણ માટે લક્ષિત સક્રિય ઘટક",
            "pa" to "ਬਿਮਾਰੀ ਕੰਟਰੋਲ ਲਈ ਟੀਚਾਬੱਧ ਤੱਤ", "bn" to "রোগ নিয়ন্ত্রণের জন্য নির্দিষ্ট সক্রিয় উপাদান",
            "ta" to "நோய் கட்டுப்பாட்டுக்கு பரிந்துரைக்கப்பட்ட மருந்து", "te" to "తెగులు నివారణకు లక్ష్యిత క్రియాశీల ఔషధం",
            "kn" to "ರೋಗ ನಿಯಂತ್ರಣಕ್ಕಾಗಿ ಗುರಿಯಿಟ್ಟ ಸಕ್ರಿಯ ಘಟಕ", "ml" to "രോഗനിയന്ത്രണത്തിനായുള്ള ഫലപ്രദമായ ഘടകം",
            "or" to "ରୋଗ ନିୟନ୍ତ୍ରଣ ପାଇଁ ଲକ୍ଷ୍ୟଭିତ୍ତିକ ସକ୍ରିୟ ଉପାଦାନ", "as" to "ৰোগ নিয়ন্ত্ৰণৰ বাবে নিৰ্দিষ্ট সক্ৰিয় উপাদান",
            "ur" to "بیماری کے تدارک کے لیے موثر فعال جزو", "mai" to "रोग नियंत्रणक लेल लक्षित सक्रिय घटक",
            "od" to "ରୋଗ ନିୟନ୍ତ୍ରଣ ପାଇଁ ଲକ୍ଷ୍ୟଭିତ୍ତିକ ସକ୍ରିୟ ଉପାଦାନ"
        )),

        Pair("recommended active ingredient", mapOf(
            "en" to "Recommended active ingredient for disease control", "hi" to "रोग नियंत्रण के लिए अनुशंसित सक्रिय घटक",
            "mr" to "रोग नियंत्रणासाठी शिफारस केलेले प्रभावी घटक", "gu" to "રોગ નિયંત્રણ માટે ભલામણ કરેલ સક્રિય ઘટક",
            "pa" to "ਬਿਮਾਰੀ ਕੰਟਰੋਲ ਲਈ ਸਿਫਾਰਸ਼ ਕੀਤਾ ਤੱਤ", "bn" to "রোগ নিয়ন্ত্রণের জন্য প্রস্তাবিত সক্রিয় উপাদান",
            "ta" to "நோய் கட்டுப்பாட்டுக்கு பரிந்துரைக்கப்பட்ட மருந்து", "te" to "తెగులు నివారణకు సిఫార్సు చేయబడిన మందు",
            "kn" to "ರೋಗ ನಿಯಂತ್ರಣಕ್ಕಾಗಿ ಶಿಫಾರಸು ಮಾಡಿದ ಘಟಕ", "ml" to "രോഗനിയന്ത്രണത്തിന് ശുപാർശ ചെയ്ത മരുന്ന്",
            "or" to "ରୋଗ ନିୟନ୍ତ୍ରଣ ପାଇଁ ସୁପାରିଶ କରାଯାଇଥିବା ଔଷଧ", "as" to "ৰোগ নিয়ন্ত্ৰণৰ বাবে অনুমোদন কৰা দ্ৰব্য",
            "ur" to "بیماری کے تدارک کے لیے تجویز کردہ جزو", "mai" to "रोग नियंत्रणक लेल अनुशंसित सक्रिय घटक",
            "od" to "ରୋଗ ନିୟନ୍ତ୍ରଣ ପାଇଁ ସୁପାରିଶ କରାଯାଇଥିବା ଔଷଧ"
        )),

        Pair("copper oxychloride", mapOf(
            "en" to "Chemical: Copper Oxychloride 50% WP (2.5 g/L) + Streptocycline (0.1 g/L) spray at 7-10 day intervals", "hi" to "रासायनिक उपाय: कॉपर ऑक्सीक्लोराइड 50% WP (2.5 ग्राम/लीटर) + स्ट्रेप्टोसाइक्लिन (0.1 ग्राम/लीटर) का 7-10 दिनों के अंतराल पर छिड़काव करें",
            "mr" to "रासायनिक उपाय: कॉपर ऑक्सिक्लोराईड 50% WP (२.५ ग्रॅम/लिटर) + स्ट्रेप्टोसायक्लिन (०.१ ग्रॅम/लिटर) ची ७-१० दिवसांच्या अंतराने फवारणी करा", "gu" to "રાસાયણિક ઉપાય: કોપર ઓક્સિક્લોરાઇડ 50% WP (2.5 ગ્રામ/લિટર) + સ્ટ્રેપ્ટોસાયક્લિન (0.1 ગ્રામ/લિટર) નો 7-10 દિવસના અંતરે છંટકાવ કરો",
            "pa" to "ਰਸਾਇਣਕ ਰੋਕਥਾਮ: ਕਾਪਰ ਆਕਸੀਕਲੋਰਾਈਡ (2.5 ਗ੍ਰਾਮ/ਲੀਟਰ) + ਸਟ੍ਰੈਪਟੋਸਾਈਕਲਿਨ (0.1 ਗ੍ਰਾਮ/ਲੀਟਰ) ਦਾ 7-10 ਦਿਨਾਂ ਬਾਅਦ ਛਿੜਕਾਅ ਕਰੋ", "bn" to "রাসায়নিক নিয়ন্ত্রণ: কপার অক্সিক্লোরাইড ৫০% WP (২.৫ গ্রাম/লিটার) + স্ট্রেপ্টোসাইক্লিন (০.১ গ্রাম/লিটার) ৭-১০ দিন পর পর স্প্রে করুন",
            "ta" to "வேதியியல் கட்டுப்பாடு: காப்பர் ஆக்ஸிகுளோரைடு (2.5 கிராம்/லிட்டர்) + ஸ்ட்ரெப்டோசைக்ளின் (0.1 கிராம்/லிட்டர்) 7-10 நாட்களுக்கு ஒருமுறை தெளிக்கவும்", "te" to "రసాయన నియంత్రణ: కాపర్ ఆక్సిక్లోరైడ్ (2.5 గ్రా/లీ) + స్ట్రెప్టోసైక్లిన్ (0.1 గ్రా/లీ) 7-10 రోజుల వ్యవధిలో పిచికారీ చేయండి",
            "kn" to "ರಾಸಾಯನಿಕ ನಿಯಂತ್ರಣ: ಕಾಪರ್ ಆಕ್ಸಿಕ್ಲೋರೈಡ್ (2.5 ಗ್ರಾಂ/ಲೀಟರ್) + ಸ್ಟ್ರೆಪ್ಟೋಸೈಕ್ಲಿನ್ (0.1 ಗ್ರಾಂ/ಲೀಟರ್) 7-10 ದಿನಗಳಿಗೊಮ್ಮೆ ಸಿಂಪಡಿಸಿ", "ml" to "രാസ നിയന്ത്രണം: കോപ്പർ ഓക്സിക്ലോറൈഡ് (2.5 ഗ്രാം/ലിറ്റർ) + സ്ട്രെപ്റ്റോസൈക്ലിൻ (0.1 ഗ്രാം/ലിറ്റർ) 7-10 ദിവസത്തിൽ തളിക്കുക",
            "or" to "ରାସାୟନିକ ନିୟନ୍ତ୍ରଣ: କପର୍ ଅକ୍ସିକ୍ଲୋରାଇଡ୍ (୨.୫ ଗ୍ରାମ୍/ଲିଟର) + ଷ୍ଟ୍ରେପ୍ଟୋସାଇକ୍ଲିନ୍ (୦.୧ ଗ୍ରାମ୍/ଲିଟର) ୭-୧୦ ଦିନରେ ସ୍ପ୍ରେ କରନ୍ତୁ", "as" to "ৰাসায়নিক নিয়ন্ত্ৰণ: কপাৰ অক্সিক্ল'ৰাইড (২.৫ গ্ৰাম/লিটাৰ) + ষ্ট্ৰেপ্ট'চাইক্লিন (০.১ গ্ৰাম/লিটাৰ) ৭-১০ দিনৰ ব্যৱধানত ছটিওৱক",
            "ur" to "کیمیائی کنٹرول: کاپر آکسی کلورائڈ (2.5 گرام/لیٹر) + اسٹریپٹوسائکلین (0.1 گرام/لیٹر) کا ہر 7-10 دن بعد سپرے کریں", "mai" to "रासायनिक नियंत्रण: कॉपर ऑक्सीक्लोराइड (2.5 ग्राम/लीटर) + स्ट्रेप्टोसाइक्लिन (0.1 ग्राम/लीटर) केर छिड़काव करू",
            "od" to "ରାସାୟନିକ ନିୟନ୍ତ୍ରଣ: କପର୍ ଅକ୍ସିକ୍ଲୋରାଇଡ୍ (୨.୫ ଗ୍ରାମ୍/ଲିଟର) + ଷ୍ଟ୍ରେପ୍ଟୋସାଇକ୍ଲିନ୍ (୦.୧ ଗ୍ରାମ୍/ଲିଟର) ୭-୧୦ ଦିନରେ ସ୍ପ୍ରେ କରନ୍ତୁ"
        )),

        Pair("bacillus subtilis", mapOf(
            "en" to "Biological: Foliar application of Bacillus subtilis or Pseudomonas fluorescens (5 g/L)", "hi" to "जैविक नियंत्रण: बैसिलस सबटिलिस या स्यूडोमोनास फ्लोरोसेंस (5 ग्राम/लीटर) का पत्तियों पर छिड़काव करें",
            "mr" to "जैविक उपाय: बॅसिलस सबटिलिस किंवा स्यूडोमोनास फ्लोरोसन्स (५ ग्रॅम/लिटर) ची पानांवर फवारणी करा", "gu" to "જૈવિક નિયંત્રણ: બેસિલસ સબટિલિસ અથવા સ્યુડોમોનાસ ફ્લોરોસેન્સ (5 ગ્રામ/લિટર) નો પાન પર છંટકાવ કરો",
            "pa" to "ਜੈਵਿਕ ਰੋਕਥਾਮ: ਬੈਸੀਲਸ ਸਬਟਿਲਿਸ ਜਾਂ ਸੂਡੋਮੋਨਾਸ ਫਲੋਰੋਸੈਂਸ (5 ਗ੍ਰਾਮ/ਲੀਟਰ) ਦਾ ਛਿੜਕਾਅ ਕਰੋ", "bn" to "জৈব নিয়ন্ত্রণ: ব্যাসিলাস সাবটিলিস বা সিউডোমোনাস ফ্লুরোসেন্স (৫ গ্রাম/লিটার) পাতায় স্প্রে করুন",
            "ta" to "இயற்கை கட்டுப்பாடு: பேசிலஸ் சப்டிலிஸ் அல்லது சூடோமோனாஸ் (5 கிராம்/லிட்டர்) இலைகளில் தெளிக்கவும்", "te" to "జీవ నియంత్రణ: బాసిల్లస్ సబ్టిలిస్ లేదా సూడోమోనాస్ (5 గ్రా/లీ) ఆకులపై పిచికారీ చేయండి",
            "kn" to "ಜೈವಿಕ ನಿಯಂತ್ರಣ: ಬ್ಯಾಸಿಲಸ್ ಸಬ್ಟಿಲಿಸ್ ಅಥವಾ ಸ್ಯೂಡೋಮೊನಾಸ್ (5 ಗ್ರಾಂ/ಲೀಟರ್) ಸಿಂಪಡಿಸಿ", "ml" to "ജൈവ നിയന്ത്രണം: ബാസിലസ് സബ്റ്റിലിസ് അല്ലെങ്കിൽ സ്യൂഡോമോണസ് (5 ഗ്രാം/ലിറ്റർ) തളിക്കുക",
            "or" to "ଜୈବିକ ନିୟନ୍ତ୍ରଣ: ବ୍ୟାସିଲସ୍ ସବଟିଲିସ୍ କିମ୍ବା ସୁଡୋମୋନାସ୍ (୫ ଗ୍ରାମ୍/ଲିଟର) ସ୍ପ୍ରେ କରନ୍ତୁ", "as" to "জৈৱিক নিয়ন্ত্ৰণ: বেচিলেচ চাবটিলিচ বা চিউড'ম'নাচ (৫ গ্ৰাম/লিটাৰ) পাতত ছটিওৱক",
            "ur" to "حیاتیاتی کنٹرول: باسیلس سبٹیلس یا سیوڈوموناس فلوروسینس (5 گرام فی لیٹر) کا سپرے کریں", "mai" to "जैविक नियंत्रण: बैसिलस सबटिलिस वा स्यूडोमोनास (5 ग्राम/लीटर) केर छिड़काव करू",
            "od" to "ଜୈବିକ ନିୟନ୍ତ୍ରଣ: ବ୍ୟାସିଲସ୍ ସବଟିଲିସ୍ କିମ୍ବା ସୁଡୋମୋନାସ୍ (୫ ଗ୍ରାମ୍/ଲିଟର) ସ୍ପ୍ରେ କରନ୍ତୁ"
        )),

        Pair("drip irrigation", mapOf(
            "en" to "Cultural: Practice drip irrigation to keep foliage dry instead of overhead sprinklers", "hi" to "कृषि पद्धतियां: पत्तियों को सूखा रखने के लिए फव्वारे की जगह ड्रिप (टपक) सिंचाई प्रणाली अपनाएं",
            "mr" to "मशागत पद्धती: पाने कोरडी राहण्यासाठी तुषार सिंचनाऐवजी ठिबक सिंचन पद्धतीचा वापर करा", "gu" to "કૃષિ પદ્ધતિ: પાંદડાં સૂકાં રાખવા માટે સ્પ્રિંકલરને બદલે ટપક સિંચાઈ પદ્ધતિ અપનાવો",
            "pa" to "ਖੇਤੀ ਤਰੀਕੇ: ਪੱਤਿਆਂ ਨੂੰ ਸੁੱਕਾ ਰੱਖਣ ਲਈ ਫੁਹਾਰਾ ਸਿੰਚਾਈ ਦੀ ਥਾਂ ਤੁਪਕਾ ਸਿੰਚਾਈ ਅਪਣਾਓ", "bn" to "কৃষি পদ্ধতি: পাতা শুকনো রাখতে ওভারহেড স্প্রিংকলারের বদলে ড্রিপ সেচ ব্যবহার করুন",
            "ta" to "பயிர் மேலாண்மை: இலைகள் ஈரமாகாமல் இருக்க தெளிப்பு நீர்ப்பாசனத்திற்கு பதிலாக சொட்டு நீர் பாசனம் பயன்படுத்தவும்", "te" to "సాగు పద్ధతులు: ఆకులు తడవకుండా ఉండటానికి స్ప్రింక్లర్లకు బదులుగా డ్రిప్ ఇరిగేషన్ వాడండి",
            "kn" to "ಕೃಷಿ ಪದ್ಧತಿ: ಎಲೆಗಳು ತೇವವಾಗುವುದನ್ನು ತಪ್ಪಿಸಲು ತುಂತುರು ನೀರಾವರಿ ಬದಲು ಹನಿ ನೀರಾವರಿ ಬಳಸಿ", "ml" to "കാർഷിക രീതികൾ: ഇലകൾ നനയാതിരിക്കാൻ തുള്ളി നന രീതി ഉപയോഗിക്കുക",
            "or" to "କୃଷି ପଦ୍ଧତି: ପତ୍ର ଶୁଖିଲା ରଖିବା ପାଇଁ ସ୍ପ୍ରିଙ୍କଲର ବଦଳରେ ବିନ୍ଦୁ ଜଳସେଚନ ବ୍ୟବହାର କରନ୍ତୁ", "as" to "কৃষি পদ্ধতি: পাত শুকান ৰাখিবলৈ স্প্ৰিংকলাৰৰ সলনি টোপাল জলসিঞ্চন ব্যৱহাৰ কৰক",
            "ur" to "زرعی طریقے: پتوں کو خشک رکھنے کے لیے فوارے کے بجائے ڈرپ اریگیشن استعمال کریں", "mai" to "कृषि पद्धति: पत्ता केँ सूखल रखबाक लेल फव्वाराक बदला ड्रिप सिंचाई करू",
            "od" to "କୃଷି ପଦ୍ଧତି: ପତ୍ର ଶୁଖିଲା ରଖିବା ପାଇଁ ସ୍ପ୍ରିଙ୍କଲର ବଦଳରେ ବିନ୍ଦୁ ଜଳସେଚନ ବ୍ୟବହାର କରନ୍ତୁ"
        )),

        Pair("certified disease-free seeds", mapOf(
            "en" to "Use certified disease-free seeds or hot water treated seeds (50°C for 25 minutes)", "hi" to "प्रमाणित रोग-मुक्त बीज का उपयोग करें या बीजों को गर्म पानी (50°C पर 25 मिनट) से उपचारित करें",
            "mr" to "प्रमाणित रोगमुक्त बियाणे वापरा किंवा बियाण्यांवर गरम पाण्याची प्रक्रिया (५०°C वर २५ मिनिटे) करा", "gu" to "પ્રમાણિત રોગમુક્ત બિયારણ વાપરો અથવા ગરમ પાણી (50°C પર 25 મિનિટ) થી બીજ માવજત કરો",
            "pa" to "ਪ੍ਰਮਾਣਿਤ ਬਿਮਾਰੀ-ਮੁਕਤ ਬੀਜ ਵਰਤੋ ਜਾਂ ਗਰਮ ਪਾਣੀ (50°C 'ਤੇ 25 ਮਿੰਟ) ਨਾਲ ਬੀਜ ਸੋਧ ਕਰੋ", "bn" to "রোগমুক্ত প্রত্যায়িত বীজ ব্যবহার করুন বা গরম পানিতে (৫০°C তাপমাত্রায় ২৫ মিনিট) শোধন করুন",
            "ta" to "சான்றளிக்கப்பட்ட நோய் தாக்காத விதைகளைப் பயன்படுத்தவும் அல்லது சுடுநீர் (50°C இல் 25 நிமிடங்கள்) நேர்த்தி செய்யவும்", "te" to "ధృవీకరించబడిన నాణ్యమైన విత్తనాలను వాడండి లేదా వేడి నీటితో (50°C వద్ద 25 నిమిషాలు) విత్తన శుద్ధి చేయండి",
            "kn" to "ಪ್ರಮಾಣೀಕೃತ ರೋಗರಹಿತ ಬೀಜಗಳನ್ನು ಬಳಸಿ ಅಥವಾ ಬಿಸಿನೀರಿನಲ್ಲಿ (50°C ನಲ್ಲಿ 25 ನಿಮಿಷ) ಬೀಜೋಪಚಾರ ಮಾಡಿ", "ml" to "രോഗബാധയില്ലാത്ത സാക്ഷ്യപ്പെടുത്തിയ വിത്തുകൾ ഉപയോഗിക്കുക അല്ലെങ്കിൽ ചൂടുവെള്ളത്തിൽ (50°C ൽ 25 മിനിറ്റ്) സംസ്കരിക്കുക",
            "or" to "ପ୍ରମାଣିତ ରୋଗମୁକ୍ତ ବିହନ ବ୍ୟବହାର କରନ୍ତୁ କିମ୍ବା ଉଷୁମ ପାଣିରେ (୫୦°C ରେ ୨୫ ମିନିଟ୍) ବିଶୋଧନ କରନ୍ତୁ", "as" to "প্ৰমাণিত ৰোগমুক্ত বীজ ব্যৱহাৰ কৰক বা গৰম পানীত (৫০°C ত ২৫ মিনিট) শোধন কৰক",
            "ur" to "تصدیق شدہ بیماری سے پاک بیج استعمال کریں یا بیجوں کو گرم پانی (50 ڈگری سینٹی گریڈ پر 25 منٹ) سے ٹریٹ کریں", "mai" to "प्रमाणित रोग-मुक्त बीयाक प्रयोग करू वा गर्म पानि (50°C पर 25 मिनट) सं बीजोपचार करू",
            "od" to "ପ୍ରମାଣିତ ରୋଗମୁକ୍ତ ବିହନ ବ୍ୟବହାର କରନ୍ତୁ କିମ୍ବା ଉଷୁମ ପାଣିରେ (୫୦°C ରେ ୨୫ ମିନିଟ୍) ବିଶୋଧନ କରନ୍ତୁ"
        )),

        Pair("crop rotation", mapOf(
            "en" to "Practice 2-3 year crop rotation avoiding same plant families", "hi" to "टमाटर, मिर्च, बैंगन और आलू से बचते हुए 2-3 वर्षीय फसल चक्र अपनाएं",
            "mr" to "टोमॅटो, मिरची, वांगी आणि बटाटा पिके टाळून २-३ वर्षांचे पीक फेरपालट करा", "gu" to "ટામેટા, મરચાં, રીંગણ અને બટાકા ટાળીને 2-3 વર્ષનું પાક ચક્ર અપનાવો",
            "pa" to "ਟਮਾਟਰ, ਮਿਰਚ, ਬੈਂਗਣ ਅਤੇ ਆਲੂ ਤੋਂ ਬਚ ਕੇ 2-3 ਸਾਲਾਂ ਦਾ ਫਸਲੀ ਚੱਕਰ ਅਪਣਾਓ", "bn" to "টমেটো, মরিচ, বেগুন ও আলু পরিহার করে ২-৩ বছরের ফসল আবর্তন পদ্ধতি অনুসরণ করুন",
            "ta" to "தக்காளி, மிளகாய், கத்தரி மற்றும் உருளைக்கிழங்கு தவிர்த்து 2-3 ஆண்டு பயிர் சுழற்சி முறையை கடைபிடிக்கவும்", "te" to "టమోటా, మిరప, వంగ మరియు బంగాళాదుంప కాకుండా 2-3 సంవత్సరాల పంట మార్పిడి చేయండి",
            "kn" to "ಟೊಮೆಟೊ, ಮೆಣಸಿನಕಾಯಿ, ಬದನೆ ಮತ್ತು ಆಲೂಗಡ್ಡೆ ಬೆಳೆಗಳನ್ನು ಹೊರತುಪಡಿಸಿ 2-3 ವರ್ಷಗಳ ಬೆಳೆ ಪರಿವರ್ತನೆ ಮಾಡಿ", "ml" to "തക്കാളി, മുളക്, വഴുതന, ഉരുളക്കിഴങ്ങ് എന്നിവ ഒഴിവാക്കി 2-3 വർഷത്തെ വിള പരിക്രമം നടത്തുക",
            "or" to "ଟମାଟୋ, ଲଙ୍କା, ବାଇଗଣ ଏବଂ ଆଳୁ ଫସଲ ବଦଳାଇ ୨-୩ ବର୍ଷର ଫସଲ ଚକ୍ର ଆପଣାନ୍ତୁ", "as" to "টমেটো, জলকীয়া, বেঙেনা আৰু আলু পৰিহাৰ কৰি ২-৩ বছৰীয়া শস্য আৱৰ্তন কৰক",
            "ur" to "ٹماٹر، مرچ، بینگن اور آلو سے بچتے ہوئے 2-3 سالہ فصلوں کے ہیر پھیر پر عمل کریں", "mai" to "टमाटर, मिर्च, भंटा आ आलू सं बचैत 2-3 बरखक फसल चक्र अपनाउ",
            "od" to "ଟମାଟୋ, ଲଙ୍କା, ବାଇଗଣ ଏବଂ ଆଳୁ ଫସଲ ବଦଳାଇ ୨-୩ ବର୍ଷର ଫସଲ ଚକ୍ର ଆପଣାନ୍ତୁ"
        )),

        Pair("metalaxyl", mapOf(
            "en" to "Chemical: Foliar spray of Metalaxyl 8% + Mancozeb 64% WP @ 2.5 g/L or Cymoxanil @ 2.5 g/L at disease onset", "hi" to "रासायनिक उपाय: रोग की शुरुआत पर मेटालेक्सिल 8% + मैंकोजेब 64% WP (2.5 ग्राम/लीटर) का छिड़काव करें",
            "mr" to "रासायनिक उपाय: रोगाच्या सुरुवातीला मेटॅलॅक्सिल ८% + मँकोझेब ६४% WP (२.५ ग्रॅम/लिटर) ची फवारणी करा", "gu" to "રાસાયણિક ઉપાય: રોગની શરૂઆતમાં મેટાલેક્સિલ 8% + મેન્કોઝેબ 64% WP (2.5 ગ્રામ/લિટર) નો છંટકાવ કરો",
            "pa" to "ਰਸਾਇਣਕ ਰੋਕਥਾਮ: ਬਿਮਾਰੀ ਦੇ ਸ਼ੁਰੂ ਵਿੱਚ ਮੈਟਾਲੈਕਸਿਲ 8% + ਮੈਨਕੋਜ਼ੇਬ 64% WP (2.5 ਗ੍ਰਾਮ/ਲੀਟਰ) ਦਾ ਛਿੜਕਾਅ ਕਰੋ", "bn" to "রাসায়নিক নিয়ন্ত্রণ: রোগের শুরুতে মেটালাক্সিল ৮% + ম্যানকোজেব ৬৪% WP (২.৫ গ্রাম/লিটার) স্প্রে করুন",
            "ta" to "வேதியியல் கட்டுப்பாடு: நோயின் தொடக்கத்தில் மெட்டாலாக்சில் 8% + மான்கோசெப் 64% WP (2.5 கிராம்/லிட்டர்) தெளிக்கவும்", "te" to "రసాయన నియంత్రణ: వ్యాధి ప్రారంభంలో మెటలాక్సిల్ 8% + మాంకోజెబ్ 64% WP (2.5 గ్రా/లీ) పిచಿಕారీ చేయండి",
            "kn" to "ರಾಸಾಯನಿಕ ನಿಯಂತ್ರಣ: ರೋಗದ ಆರಂಭದಲ್ಲಿ ಮೆಟಲಾಕ್ಸಿಲ್ 8% + ಮ್ಯಾಂಕೋಜೆಬ್ 64% WP (2.5 ಗ್ರಾಂ/ಲೀಟರ್) ಸಿಂಪಡಿಸಿ", "ml" to "രാസ നിയന്ത്രണം: രോഗാരംഭത്തിൽ മെറ്റാലാക്സിൽ 8% + മാങ്കോസെബ് 64% WP (2.5 ഗ്രാം/ലിറ്റർ) തളിക്കുക",
            "or" to "ରାସାୟନିକ ନିୟନ୍ତ୍ରଣ: ରୋଗର ଆରମ୍ଭରେ ମେଟାଲାକ୍ସିଲ୍ ୮% + ମାଙ୍କୋଜେବ୍ ୬୪% WP (୨.୫ ଗ୍ରାମ୍/ଲିଟର) ସ୍ପ୍ରେ କରନ୍ତୁ", "as" to "ৰাসায়নিক নিয়ন্ত্ৰণ: ৰোগৰ আৰম্ভণিতে মেটালেক্সিল ৮% + মেনক'জেব ৬৪% WP (২.৫ গ্ৰাম/লিটাৰ) ছটিওৱক",
            "ur" to "کیمیائی کنٹرول: بیماری کے آغاز پر میٹالیکسل 8% + مینکوزیب 64% ڈبلیو پی (2.5 گرام/لیٹر) کا سپرے کریں", "mai" to "रासायनिक नियंत्रण: रोगक शुरुआत भेला पर मेटालेक्सिल 8% + मैंकोजेब 64% WP केर छिड़काव करू",
            "od" to "ରାସାୟନିକ ନିୟନ୍ତ୍ରଣ: ରୋଗର ଆରମ୍ଭରେ ମେଟାଲାକ୍ସିଲ୍ ୮% + ମାଙ୍କୋଜେବ୍ ୬୪% WP (୨.୫ ଗ୍ରାମ୍/ଲିଟର) ସ୍ପ୍ରେ କରନ୍ତୁ"
        )),

        Pair("difenoconazole", mapOf(
            "en" to "Chemical: Foliar spray of Azoxystrobin + Difenoconazole @ 1 ml/L or Tebuconazole @ 1 ml/L upon lesion appearance", "hi" to "रासायनिक उपाय: लक्षण दिखते ही एजोक्सीस्ट्रोबिन + डाइफेनोकोनाजोल (1 मिली/लीटर) या टेबुकोनाजोल (1 मिली/लीटर) का छिड़काव करें",
            "mr" to "रासायनिक उपाय: लक्षणे दिसताच अझॉक्सिस्ट्रोबिन + डायफेनोकोनाझोल (१ मिली/लिटर) किंवा टेबुकोनाझोल फवारा", "gu" to "રાસાયણિક ઉપાય: લક્ષણો દેખાય ત્યારે એઝોક્સિસ્ટ્રોબિન + ડિફેનોકોનાઝોલ (1 મિલી/લિટર) અથવા ટેબુકોનાઝોલનો છંટકાવ કરો",
            "pa" to "ਰਸਾਇਣਕ ਰੋਕਥਾਮ: ਲੱਛਣ ਦਿਸਣ 'ਤੇ ਐਜ਼ੋਕਸੀਸਟ੍ਰੋਬਿਨ + ਡਾਈਫੇਨੋਕੋਨਾਜ਼ੋਲ (1 ਮਿ.ਲੀ./ਲੀਟਰ) ਦਾ ਛਿੜਕਾਅ ਕਰੋ", "bn" to "রাসায়নিক নিয়ন্ত্রণ: লক্ষণ দেখা দিলে অ্যাজোক্সিস্ট্রোবিন + ডাইফেনোকোনাজোল (১ মিলি/লিটার) স্প্রে করুন",
            "ta" to "வேதியியல் கட்டுப்பாடு: அறிகுறிகள் தெரிந்தவுடன் அஸோக்ஸிஸ்ட்ரோபின் + டைபினோகோனசோல் (1 மி.லி/லிட்டர்) தெளிக்கவும்", "te" to "రసాయన నియంత్రణ: లక్షణాలు కనిపించిన వెంటనే అజోక్సిస్ట్రోబిన్ + డైఫెనోకోనజోల్ (1 మి.లీ/లీ) పిచಿಕారీ చేయండి",
            "kn" to "ರಾಸಾಯನಿಕ ನಿಯಂತ್ರಣ: ಲಕ್ಷಣಗಳು ಕಂಡಾಗ ಅಜಾಕ್ಸಿಸ್ಟ್ರೋಬಿನ್ + ಡೈಫೆನೊಕೊನಾಜೋಲ್ (1 ಮಿ.ಲೀ/ಲೀಟರ್) ಸಿಂಪಡಿಸಿ", "ml" to "രാസ നിയന്ത്രണം: ലക്ഷണങ്ങൾ കാണുമ്പോൾ അസോക്സിസ്ട്രോബിൻ + ഡിഫെനൊകൊണസോൾ (1 മി.ലി/ലിറ്റർ) തളിക്കുക",
            "or" to "ରାସାୟନିକ ନିୟନ୍ତ୍ରଣ: ଲକ୍ଷଣ ଦେଖାଯିବା ମାତ୍ରେ ଆଜୋକ୍ସିଷ୍ଟ୍ରୋବିନ୍ + ଡାଇଫେନୋକୋନାଜୋଲ୍ (୧ ମିଲି/ଲିଟର) ସ୍ପ୍ରେ କରନ୍ତୁ", "as" to "ৰাসায়নিক নিয়ন্ত্ৰণ: লক্ষণ দেখা পালে এজ'ক্সিষ্ট্ৰ'বিন + ডাইফেন'ক'নাজ'ল (১ মি.লি./লিটাৰ) ছটিওৱক",
            "ur" to "کیمیائی کنٹرول: علامات ظاہر ہوتے ہی ایزوکسیسٹروبن + ڈائی فینوکونازول (1 ملی لیٹر/لیٹر) کا سپرے کریں", "mai" to "रासायनिक नियंत्रण: लक्षण देखिते एजोक्सीस्ट्रोबिन + डाइफेनोकोनाजोल केर छिड़काव करू",
            "od" to "ରାସାୟନିକ ନିୟନ୍ତ୍ରଣ: ଲକ୍ଷଣ ଦେଖାଯିବା ମାତ୍ରେ ଆଜୋକ୍ସିଷ୍ଟ୍ରୋବିନ୍ + ଡାଇଫେନୋକୋନାଜୋଲ୍ (୧ ମିଲି/ଲିଟର) ସ୍ପ୍ରେ କରନ୍ତୁ"
        )),

        Pair("organic beneficial bio-fungicide", mapOf(
            "en" to "Organic beneficial bio-fungicide for seed & soil treatment", "hi" to "बीज और मिट्टी उपचार के लिए जैविक जैव-कवकनाशी",
            "mr" to "बियाणे व माती उपचारासाठी सेंद्रिय जैविक बुरशीनाशक", "gu" to "બીજ અને જમીન માવજત માટે જૈવિક ફૂગનાશક",
            "pa" to "ਬੀਜ ਅਤੇ ਮਿੱਟੀ ਦੇ ਇਲਾਜ ਲਈ ਜੈਵਿਕ ਉੱਲੀਨਾਸ਼ਕ", "bn" to "বীজ ও মাটি শোধনের জন্য উপকারী জৈব ছত্রাকনাশক",
            "ta" to "விதை மற்றும் மண் நேர்த்திக்கு இயற்கை பூஞ்சைக் கொல்லி", "te" to "విత్తన మరియు నేల శుద్ధికి ఉపయోగపడే జీవ శిలీంధ్ర సంహారిణి",
            "kn" to "ಬೀಜ ಮತ್ತು ಮಣ್ಣಿನ ಉಪಚಾರಕ್ಕಾಗಿ ಜೈವಿಕ ಶಿಲೀಂಧ್ರನಾಶಕ", "ml" to "വിത്ത്, മണ്ണ് സംസ്കരണത്തിനായുള്ള ജൈവ കുമിൾനാശിനി",
            "or" to "ବିହନ ଏବଂ ମାଟି ବିଶୋଧନ ପାଇଁ ଜୈବିକ କବକନାଶକ", "as" to "বীজ আৰু মাটি শোধনৰ বাবে উপকাৰী জৈৱিক ভেঁকুৰনাশক",
            "ur" to "بیج اور مٹی کے علاج کے لیے مفید نامیاتی حیاتیاتی پھپھوندی کش", "mai" to "बीया आ माटिक उपचारक लेल जैविक कवकनाशी",
            "od" to "ବିହନ ଏବଂ ମାଟି ବିଶୋଧନ ପାଇଁ ଜୈବିକ କବକନାଶକ"
        )),

        Pair("effective against rusts", mapOf(
            "en" to "Effective against rusts and blights in crops", "hi" to "फसलों में रतुआ और झुलसा रोग के खिलाफ अत्यंत प्रभावी",
            "mr" to "पिकांमधील तांबेरा आणि करपा रोगावर अत्यंत प्रभावी", "gu" to "પાકમાં ગેરુ અને સુકારા સામે અસરકારક",
            "pa" to "ਫਸਲਾਂ ਵਿੱਚ ਕੁੰਗੀ ਅਤੇ ਝੁਲਸ ਰੋਗ ਵਿਰੁੱਧ ਅਸਰਦਾਰ", "bn" to "ফসলের মরিচা ও ধসা রোগের বিরুদ্ধে অত্যন্ত কার্যকর",
            "ta" to "பயிர்களில் துரு மற்றும் கருகல் நோய்க்கு மிகவும் பயனுள்ளது", "te" to "పంటలలో తుప్పు మరియు తెగుళ్లపై అత్యంత సమర్థవంతమైనది",
            "kn" to "ಬೆಳೆಗಳಲ್ಲಿ ತುಕ್ಕು ಮತ್ತು ಕರಕಲು ರೋಗದ ವಿರುದ್ಧ ಪರಿಣಾಮಕಾರಿ", "ml" to "വിളകളിലെ തുരുമ്പ്, കരിച്ചിൽ എന്നിവയ്‌ക്കെതിരെ ഫലപ്രദം",
            "or" to "ଫସଲରେ କଳଙ୍କି ଏବଂ ଝାଉଁଳା ରୋଗ ବିରୁଦ୍ଧରେ ପ୍ରଭାବଶାଳୀ", "as" to "শস্যৰ মামৰ আৰু পাত শুকোৱা ৰোগৰ বিৰুদ্ধে কাৰ্যকৰী",
            "ur" to "فصلوں میں زنگ اور جھلسائو کے خلاف انتہائی مؤثر", "mai" to "फसल मे गेरुआ आ झुलसा केर विरुद्ध अत्यंत प्रभावी",
            "od" to "ଫସଲରେ କଳଙ୍କି ଏବଂ ଝାଉଁଳା ରୋଗ ବିରୁଦ୍ଧରେ ପ୍ରଭାବଶାଳୀ"
        )),

        Pair("organic bio-pesticide", mapOf(
            "en" to "Organic bio-pesticide and insect vector deterrent", "hi" to "जैविक कीटनाशक और रस चूसक कीटों से सुरक्षा",
            "mr" to "सेंद्रिय कीटकनाशक आणि रसशोषक किडींपासून संरक्षण", "gu" to "જૈવિક કીટનાશક અને રસ ચૂસતી જીવાતો સામે રક્ષણ",
            "pa" to "ਜੈਵਿਕ ਕੀਟਨਾਸ਼ਕ ਅਤੇ ਰਸ ਚੂਸਣ ਵਾਲੇ ਕੀੜਿਆਂ ਤੋਂ ਬਚਾਅ", "bn" to "জৈব কীটনাশক এবং ক্ষতিকারক পোকা মাকড় প্রতিরোধক",
            "ta" to "இயற்கை பூச்சிக்கொல்லி மற்றும் சாறு உறிஞ்சும் பூச்சிகள் தடுப்பு", "te" to "జీవ పురుగుమందు మరియు రసం పీల్చే పురుగుల నివారణ",
            "kn" to "ಜೈವಿಕ ಕೀಟನಾಶಕ ಮತ್ತು ರಸ ಹೀರುವ ಕೀಟಗಳಿಂದ ರಕ್ಷಣೆ", "ml" to "ജൈവ കീടനാശിനിയും കീട പ്രതിരോധവും",
            "or" to "ଜୈବିକ କୀଟନାଶକ ଏବଂ ଶୋଷକ କୀଟଙ୍କଠାରୁ ସୁରକ୍ଷା", "as" to "জৈৱিক কীটনাশক আৰু ৰস শুহি খোৱা পোকৰ পৰা সুৰক্ষা",
            "ur" to "نامیاتی کیڑے مار دوا اور نقصان دہ کیڑوں سے تحفظ", "mai" to "जैविक कीटनाशक आ रस चूसक कीट सं सुरक्षा",
            "od" to "ଜୈବିକ କୀଟନାଶକ ଏବଂ ଶୋଷକ କୀଟଙ୍କଠାରୁ ସୁରକ୍ଷା"
        )),

        Pair("broad-spectrum protection", mapOf(
            "en" to "Broad-spectrum protection for fungal spots & blights", "hi" to "फफूंद जनित धब्बों और झुलसा के लिए व्यापक सुरक्षा",
            "mr" to "बुरशीजन्य ठिपके व करपा रोगासाठी व्यापक संरक्षण", "gu" to "ફૂગજન્ય ટપકાં અને સુકારા સામે વ્યાપક રક્ષણ",
            "pa" to "ਉੱਲੀ ਦੇ ਧੱਬਿਆਂ ਅਤੇ ਝੁਲਸ ਰੋਗ ਲਈ ਵਿਆਪਕ ਬਚਾਅ", "bn" to "ছত্রাকজনিত দাগ ও ধসা রোগের ব্যাপক সুরক্ষা",
            "ta" to "பூஞ்சை புள்ளிகள் மற்றும் கருகலுக்கு பரந்த அளவிலான பாதுகாப்பு", "te" to "శిలీంధ్ర మచ్చలు మరియు తెగుళ్లపై సమగ్ర రక్షణ",
            "kn" to "ಶಿಲೀಂಧ್ರ ಕಲೆಗಳು ಮತ್ತು ಕರಕಲು ರೋಗಕ್ಕೆ ರಕ್ಷಣೆ", "ml" to "കുമിൾ പൊട്ടുകൾക്കും കരിച്ചിലിനുമെതിരെ സമഗ്ര സംരക്ഷണം",
            "or" to "ଫିମ୍ପି ଦାଗ ଏବଂ ଝାଉଁଳା ରୋଗ ପାଇଁ ବ୍ୟାପକ ସୁରକ୍ଷା", "as" to "ভেঁকুৰৰ দাগ আৰু পাত শুকোৱা ৰোগৰ বাবে বিস্তৃত সুৰক্ষা",
            "ur" to "پھپھوندی کے داغوں اور جھلسائو کے لیے وسیع تحفظ", "mai" to "फफूंद जनित धब्बा आ झुलसाक लेल व्यापक सुरक्षा",
            "od" to "ଫିମ୍ପି ଦାଗ ଏବଂ ଝାଉଁଳା ରୋଗ ପାଇଁ ବ୍ୟାପକ ସୁରକ୍ଷା"
        )),

        Pair("antibacterial agricultural", mapOf(
            "en" to "Antibacterial agricultural bactericide formulation", "hi" to "जीवाणुरोधी कृषि सूत्रीकरण (बैक्टीरीसाइड)",
            "mr" to "जिवाणूनाशक कृषी औषध", "gu" to "જીવાણુનાશક કૃષિ દવા",
            "pa" to "ਜੀਵਾਣੂਨਾਸ਼ਕ ਖੇਤੀਬਾੜੀ ਦਵਾਈ", "bn" to "ব্যাকটেরিয়ানাশক কৃষি ওষুধ",
            "ta" to "பாக்டீரியா எதிர்ப்பு வேளாண் மருந்து", "te" to "బ్యాక్టీరియా నివారిణి వ్యవసాయ మందు",
            "kn" to "ಬ್ಯಾಕ್ಟೀರಿಯಾ ನಿವಾರಕ ಕೃಷಿ ಔಷಧ", "ml" to "ബാക്ടീരിയ നാശിനി കാർഷിക മരുന്ന്",
            "or" to "ଜୀବାଣୁନାଶକ କୃଷି ଔଷଧ", "as" to "বেক্টেৰিয়ানাশক কৃষি ঔষধ",
            "ur" to "بیکٹیریل زرعی دوا", "mai" to "जीवाणुरोधी कृषि दवाई",
            "od" to "ଜୀବାଣୁନାଶକ କୃଷି ଔଷଧ"
        )),

        Pair("systemic fungicide", mapOf(
            "en" to "Effective systemic fungicide formulation", "hi" to "प्रभावी प्रणालीगत कवकनाशी (फंगीसाइड)",
            "mr" to "प्रभावी आंतरप्रवाही बुरशीनाशक", "gu" to "અસરકારક પ્રણાલીગત ફૂગનાશક",
            "pa" to "ਅਸਰਦਾਰ ਉੱਲੀਨਾਸ਼ਕ ਦਵਾਈ", "bn" to "কার্যকর ছত্রাকনাশক ওষুধ",
            "ta" to "செயல்திறன் மிக்க பூஞ்சைக் கொல்லி", "te" to "సమర్థవంతమైన శిలీంధ్ర సంహారిణి",
            "kn" to "ಪರಿಣಾಮಕಾರಿ ಶಿಲೀಂಧ್ರನಾಶಕ", "ml" to "ഫലപ്രദമായ കുമിൾനാശിനി",
            "or" to "ପ୍ରଭାବଶାଳୀ କବକନାଶକ", "as" to "কাৰ্যকৰী ভেঁকুৰনাশক",
            "ur" to "مؤثر پھپھوندی کش دوا", "mai" to "प्रभावी कवकनाशी दवाई",
            "od" to "ପ୍ରଭାବଶାଳୀ କବକନାଶକ"
        )),

        Pair("use as per label", mapOf(
            "en" to "Use as per label; wear PPE. Prefer extension-office advice.", "hi" to "लेबल के अनुसार उपयोग करें; सुरक्षा किट पहनें और विशेषज्ञ की सलाह लें",
            "mr" to "लेबलनुसार वापर करा; संरक्षणात्मक किट वापरा आणि तज्ञांचा सल्ला घ्या", "gu" to "લેબલ મુજબ ઉપયોગ કરો; સુરક્ષા કીટ પહેરો અને નિષ્ણાતની સલાહ લો",
            "pa" to "ਲੇਬਲ ਅਨੁਸਾਰ ਵਰਤੋਂ; ਸੁਰੱਖਿਆ ਕਿੱਟ ਪਾਓ ਅਤੇ ਮਾਹਿਰ ਦੀ ਸਲਾਹ ਲਵੋ", "bn" to "লেবেল অনুযায়ী ব্যবহার করুন; পিপিই পরুন এবং কৃষি কর্মকর্তার পরামর্শ নিন",
            "ta" to "லேபிள் படி பயன்படுத்தவும்; கவச உடை அணியவும், வேளாண் வல்லுநர் ஆலோசனை பெறவும்", "te" to "లేబుల్ ప్రకారం వాడండి; రక్షణ కిట్ ధరించండి మరియు నిపుణుల సలహా తీసుకోండి",
            "kn" to "ಲೇಬಲ್ ಪ್ರಕಾರ ಬಳಸಿ; ಸುರಕ್ಷತಾ ಉಡುಪು ಧರಿಸಿ ಮತ್ತು ತಜ್ಞರ ಸಲಹೆ ಪಡೆಯಿರಿ", "ml" to "ലേബൽ നിർദ്ദേശപ്രകാരം ഉപയോഗിക്കുക; സുരക്ഷാ വസ്ത്രങ്ങൾ ധരിക്കുക",
            "or" to "ଲେବଲ୍ ଅନୁଯାୟୀ ବ୍ୟବହାର କରନ୍ତୁ; ସୁରକ୍ଷା ପୋଷାକ ପିନ୍ଧନ୍ତୁ ଏବଂ ବିଶେଷଜ୍ଞଙ୍କ ପରାମର୍ଶ ନିଅନ୍ତୁ", "as" to "লেবেল অনুসৰি ব্যৱহাৰ কৰক; সুৰক্ষা কিট পিন্ধক আৰু বিশেষজ্ঞৰ পৰামৰ্শ লওক",
            "ur" to "لیبل کے مطابق استعمال کریں؛ حفاظتی کٹ پہنیں اور ماہرین سے مشورہ لیں", "mai" to "लेबलक अनुसार उपयोग करू; सुरक्षा किट पहिरू आ विशेषज्ञक सलाह लियौ",
            "od" to "ଲେବଲ୍ ଅନୁଯାୟୀ ବ୍ୟବହାର କରନ୍ତୁ; ସୁରକ୍ଷା ପୋଷାକ ପିନ୍ଧନ୍ତୁ ଏବଂ ବିଶେଷଜ୍ଞଙ୍କ ପରାମର୍ଶ ନିଅନ୍ତୁ"
        )),

        Pair("destroy infected plant debris", mapOf(
            "en" to "Cultural: Destroy infected plant debris after harvest; use drip irrigation", "hi" to "कृषि पद्धतियां: कटाई के बाद संक्रमित अवशेषों को नष्ट करें; ड्रिप सिंचाई अपनाएं",
            "mr" to "मशागत पद्धती: काढणीनंतर बाधित पिकांचे अवशेष नष्ट करा; ठिबक सिंचन वापरा", "gu" to "કૃષિ પદ્ધતિ: લણણી પછી સંક્રમિત અવશેષોનો નાશ કરો; ટપક સિંચાઈ અપનાવો",
            "pa" to "ਖੇਤੀ ਤਰੀਕੇ: ਕਟਾਈ ਤੋਂ ਬਾਅਦ ਬਿਮਾਰ ਰਹਿੰਦ-ਖੂੰਹਦ ਨੂੰ ਨਸ਼ਟ ਕਰੋ; ਤੁਪਕਾ ਸਿੰਚਾਈ ਅਪਣਾਓ", "bn" to "কৃষি পদ্ধতি: ফসল তোলার পর আক্রান্ত অবশিষ্টাংশ পুড়িয়ে ফেলুন; ড্রিপ সেচ দিন",
            "ta" to "பயிர் மேலாண்மை: அறுவடைக்குப் பின் பாதிக்கப்பட்ட பயிர் கழிவுகளை அழிக்கவும்; சொட்டு நீர் பாசனம் செய்யவும்", "te" to "సాగు పద్ధతులు: కోత తర్వాత తెగులు సోకిన అవశేషాలను నాశనం చేయండి; డ్రిప్ ఇరిగేషన్ వాడండి",
            "kn" to "ಕೃಷಿ ಪದ್ಧತಿ: ಕೊಯ್ಲಿನ ನಂತರ ರೋಗಪೀಡಿತ ಬೆಳೆ ತ್ಯಾಜ್ಯವನ್ನು ನಾಶಮಾಡಿ; ಹನಿ ನೀರಾವರಿ ಬಳಸಿ", "ml" to "കാർഷിക രീതികൾ: വിളവെടുപ്പിന് ശേഷം രോഗബാധിത അവശിഷ്ടങ്ങൾ നശിപ്പിക്കുക; തുള്ളി നന സ്വീകരിക്കുക",
            "or" to "କୃଷି ପଦ୍ଧତି: ଅମଳ ପରେ ସଂକ୍ରମିତ ଅବଶିଷ୍ଟାଂଶ ନଷ୍ଟ କରନ୍ତୁ; ବିନ୍ଦୁ ଜଳସେଚନ କରନ୍ତୁ", "as" to "কৃষি পদ্ধতি: শস্য চপোৱাৰ পিছত সংক্ৰমিত অৱশিষ্ট ধ্বংস কৰক; টোপাল জলসিঞ্চন ব্যৱহাৰ কৰক",
            "ur" to "زرعی طریقے: فصل کی کٹائی کے بعد متاثرہ باقیات کو تلف کریں؛ ڈرپ اریگیشن استعمال کریں", "mai" to "कृषि पद्धति: कटनीक बाद संक्रमित अवशेष केँ नष्ट करू; ड्रिप सिंचाई करू",
            "od" to "କୃଷି ପଦ୍ଧତି: ଅମଳ ପରେ ସଂକ୍ରମିତ ଅବଶିଷ୍ଟାଂଶ ନଷ୍ଟ କରନ୍ତୁ; ବିନ୍ଦୁ ଜଳସେଚନ କରନ୍ତୁ"
        )),

        Pair("deep summer ploughing", mapOf(
            "en" to "Cultural: Deep summer ploughing to expose fungal resting spores to direct sunlight", "hi" to "कृषि पद्धतियां: फफूंद के बीजाणुओं को नष्ट करने के लिए गर्मियों में गहरी जुताई करें",
            "mr" to "मशागत पद्धती: बुरशीचे बीजाणू नष्ट करण्यासाठी उन्हाळ्यात खोल नांगरट करा", "gu" to "કૃષિ પદ્ધતિ: ફૂગના બીજકણનો નાશ કરવા ઉનાળામાં ઊંડી ખેડ કરો",
            "pa" to "ਖੇਤੀ ਤਰੀਕੇ: ਉੱਲੀ ਦੇ ਬੀਜਾਣੂਆਂ ਨੂੰ ਨਸ਼ਟ ਕਰਨ ਲਈ ਗਰਮੀਆਂ ਵਿੱਚ ਡੂੰਘੀ ਵਾਹੀ ਕਰੋ", "bn" to "কৃষি পদ্ধতি: ছত্রাকের জীবাণু ধ্বংস করতে গ্রীষ্মকালে গভীর চাষ দিন",
            "ta" to "பயிர் மேலாண்மை: பூஞ்சை வித்துக்களை அழிக்க கோடையில் ஆழ உழவு செய்யவும்", "te" to "సాగు పద్ధతులు: శిలీంధ్ర బీజాలను నశింపజేయడానికి వేసవిలో లోతు దుక్కులు దున్నండి",
            "kn" to "ಕೃಷಿ ಪದ್ಧತಿ: ಶಿಲೀಂಧ್ರ ಬೀಜಕಗಳನ್ನು ನಾಶಮಾಡಲು ಬೇಸಿಗೆಯಲ್ಲಿ ಆಳವಾದ ಉಳುಮೆ ಮಾಡಿ", "ml" to "കാർഷിക രീതികൾ: കുമിൾ ബീജങ്ങളെ നശിപ്പിക്കാൻ വേനൽക്കാലത്ത് ആഴത്തിൽ ഉഴുക",
            "or" to "କୃଷି ପଦ୍ଧତି: କବକ ନଷ୍ଟ କରିବା ପାଇଁ ଖରାଦିନେ ଗଭୀର ହଳ କରନ୍ତୁ", "as" to "কৃষি পদ্ধতি: ভেঁকুৰৰ বীজাণু ধ্বংস কৰিবলৈ গ্ৰীষ্মকালত গভীৰ হাল বাওক",
            "ur" to "زرعی طریقے: پھپھوندی کے ذرات کو ختم کرنے کے لیے گرمیوں میں گہری جوتائی کریں", "mai" to "कृषि पद्धति: फफूंद केँ नष्ट करबाक लेल गर्मी मे गहीर जोताई करू",
            "od" to "କୃଷି ପଦ୍ଧତି: କବକ ନଷ୍ଟ କରିବା ପାଇଁ ଖରାଦିନେ ଗଭୀର ହଳ କରନ୍ତୁ"
        )),

        Pair("foliage is wet", mapOf(
            "en" to "Avoid working in fields when foliage is wet to prevent spreading pathogens", "hi" to "पत्तियां गीली होने पर खेत में काम करने से बचें ताकि रोग न फैले",
            "mr" to "पाने ओली असताना शेतात काम करणे टाळा जेणेकरून रोगाचा प्रसार होणार नाही", "gu" to "પાંદડાં ભીનાં હોય ત્યારે ખેતરમાં કામ કરવાનું ટાળો જેથી રોગ ન ફેલાય",
            "pa" to "ਪੱਤੇ ਗਿੱਲੇ ਹੋਣ 'ਤੇ ਖੇਤ ਵਿੱਚ ਕੰਮ ਕਰਨ ਤੋਂ ਬਚੋ ਤਾਂ ਜੋ ਬਿਮਾਰੀ ਨਾ ਫੈਲੇ", "bn" to "পাতা ভেজা থাকা অবস্থায় জমিতে কাজ করা পরিহার করুন যাতে রোগ না ছড়ায়",
            "ta" to "இலைகள் ஈரமாக இருக்கும் போது வயலில் வேலை செய்வதைத் தவிர்க்கவும்", "te" to "ఆకులు తడిగా ఉన్నప్పుడు పొలంలో పని చేయవద్దు",
            "kn" to "ಎಲೆಗಳು ತೇವವಾಗಿರುವಾಗ ಹೊಲದಲ್ಲಿ ಕೆಲಸ ಮಾಡುವುದನ್ನು ತಪ್ಪಿಸಿ", "ml" to "ഇലകൾ നനഞ്ഞിരിക്കുമ്പോൾ തോട്ടത്തിൽ ജോലി ചെയ്യുന്നത് ഒഴിവാക്കുക",
            "or" to "ପତ୍ର ଓଦା ଥିବା ସମୟରେ କ୍ଷେତରେ କାମ କରିବା ବନ୍ଦ କରନ୍ତୁ", "as" to "পাত তিতা হৈ থকা অৱস্থাত পথাৰত কাম কৰাৰ পৰা বিৰত থাকক",
            "ur" to "پتے گیلੇ ہونے پر کھیت میں کام کرنے سے گریز کریں", "mai" to "पत्ता भीजल रहला पर खेत मे काज करय सं बचू जाहि सं बीमारी नहि फैलय",
            "od" to "ପତ୍ର ଓଦା ଥିବା ସମୟରେ କ୍ଷେତରେ କାମ କରିବା ବନ୍ଦ କରନ୍ତୁ"
        )),
    ...
    fun localizeDiseaseAdvice(text: String?, langCode: String): String {
        ...
        // 0. Store card subtitle match for active ingredients
        if (normalized.contains("active ingredient")) {
            val key = if (normalized.contains("recommended")) "recommended active ingredient" else "targeted active ingredient"
    ...
    private val HARVESTING_PHRASES = mapOf(
        ...
        "crop storage" to mapOf(
            "en" to "Crop Storage", "hi" to "फसल भंडारण", "gu" to "પાક સંગ્રહ", "mr" to "पीक साठवण",
            "pa" to "ਫ਼ਸਲ ਭੰਡਾਰਨ", "bn" to "শস্য সংরক্ষণাগার", "ta" to "பயிர் சேமிப்பகம்", "te" to "పంట నిల్వ కేంద్రం",
            "kn" to "ಬೆಳೆ ಶೇಖರಣೆ", "ml" to "വിള സംഭരണം", "or" to "ଫସଲ ସଂରକ୍ଷଣ", "as" to "শস্য ভঁৰাল",
            "ur" to "فصل کا ذخیرہ", "mai" to "फसल भंडारण"
        ),
